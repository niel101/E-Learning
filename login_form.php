			...
			<form id="login_form1" class="form-signin" method="post">
						...
						<input type="text" class="input-block-level" id="username" name="username" placeholder="Username" autocomplete="off"required>
						<input type="password" class="input-block-level" id="password" name="password" placeholder="Password" autocomplete="off" required>
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to E-Learning Visual Basic.Net for Grade 12 ICT System", { header: 'Access Granted' });
									var delay = 1000;
										setTimeout(function(){ window.location = 'dasboard_teacher.php'  }, delay);  
									}else if (html == 'true_student'){
										$.jGrowl("Welcome to San jose Del Monte National High School", { header: 'Access Granted' });
									var delay = 1000;
		...
		<h5 style="color:red;">Student | Teacher login</h5>
			<!--New Users sign here...
			<hr>
