     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li> <a href="dashboard.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> </li>
							<li>
                            <a href="lessons.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Lessons</a>
                        </li>
						<li>
						...
						<li class="">
                            <a href="quiz.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Quizzes</a>
                        </li>	
						<li class="">
                            <a href="score_board.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Score Board</a>
                        </li>
						<li class="">
